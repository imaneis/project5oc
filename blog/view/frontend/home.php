...
<header id="head">
    <div class="container">
        <div class="row">
            ...
            <p><a class="btn btn-default btn-lg" role="button" href="#section">en savoir plus</a> <a class="btn btn-action btn-lg" href="cv.zip" role="button">Mon CV</a></p>
        </div>
    </div>
</header>
<!-- /Header -->
    ...
    <div class="container" id="section">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 highlight">
                <div class="h-caption">
                    <h4><i class="fa fa-cogs fa-5"></i>Résultat a la hauteur de l'attende du client</h4>
                </div>
            ...
            <div class="col-md-3 col-sm-6 highlight">
                <div class="h-caption">
                    <h4><i class="fa fa-flash fa-5"></i>le respect des délais un engagement</h4>
                </div>
                <div class="h-body text-center">
                    <p>Afin de vous proposer un service de qualité, je vous informerais a l'avance
                        du délais nécessaire pour la livraison du produit finale
                    </p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 highlight">
                <div class="h-caption">
                    <h4><i class="fa fa-heart fa-5"></i>Créativité et flexibilité</h4>
                </div>
                <div class="h-body text-center">
            ...
            <div class="col-md-3 col-sm-6 highlight">
                <div class="h-caption">
                    <h4><i class="fa fa-smile-o fa-5"></i>dans l'attentes de vos
                        retours
                    </h4>
                </div>
                <div class="h-body text-center">
                    <p>Si mes services vous ont satisfait je serais dans l'attentes de vos retours afin
                        de m'améliorer et vous proposer une meilleur qualité et prendre compte de vos demandes
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 widget">
                    <div class="widget-body">
                        <p class="follow-me-icons clearfix">
                            <a href="https://github.com/imaneis"><i class="fa fa-github fa-2"></i></a>
