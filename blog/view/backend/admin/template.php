    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav pull-right">
                ...
                <li><a href="index.php?action=logIn">Liste des articles</a></li>
                <li><a href="index.php?action=showComments">Liste des commentaires</a></li>
                <li><a href="index.php?action=showMembers">Liste des utilisateurs</a></li>
...
<?= $content ?>
<!-- /container -->
<footer id="footer" class="top-space" style="margin-top: 200px;">
